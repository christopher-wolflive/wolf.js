...
export default class AchievementRequests {
     ...
     */
    static AchievementList = async (io: IO, idList?: number[], languageId?: number) => await io.Emit('achievement list', (() => {
        let data: any = {};
     ...
     */
    static AchievementSubscriberList = async (io: IO, id: number, parentId?: number, order?: string) => await io.Emit('achievement subscriber list', (() => {
        let data: any = { id };
